...
if (length(args) != 4)
{
  ...
  age_range <- Age_ranges_Coefficients[[demo_group]][n]
}
...
print(paste("Demographic group = ", demo_group, ", Age range = ", age_range, ", coefficients and correlation matrices.", sep = ""))

#COEFFICIENTS AND CORRELATION SQUARES
generate_coefficients_and_correlations_sw(demo_group, age_range)
print("Generated coefficients and correlation matrices.")
